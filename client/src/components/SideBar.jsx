    ...
    <div>
      <div className={`${open ? 'w-80' : 'w-20 md:w-24'} bg-black min-h-screen border-r-2 border-gray-700 p-5 flex flex-col items-center pt-8 relative duration-300`}>
        ...
        <ul className="pt-6">
          ...
          <Link to='/premium' className='flex items-center gap-x-4'>

          <li className={`flex rounded-md p-2 cursor-pointer hover:bg-light-white text-green text-lg items-center gap-x-4 mt-2`}>
            <TbStar style={{ width: '30px', height: '30px' }} />
            <span className={`${!open && 'hidden'} origin-left duration-200`}>Premium</span>
          </li>
          </Link>
          <li className={`flex rounded-md p-2 cursor-pointer hover:bg-light-white text-gray-300 text-lg items-center gap-x-4 mt-2`}>
