    ...
    <div className="w-full bg-black text-gray-200 py-16 px-6 md:px-16">
      <div className="max-w-7xl mx-auto flex flex-col items-center gap-8">
        ...
        <button className="relative overflow-hidden h-12 px-8 rounded-md border-2 border-green bg-green text-gray-200 cursor-pointer group mt-10">
          ...
          <span className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-[#6C63FF] to-[#4540a9] scale-x-0 group-hover:scale-x-100 transition-transform duration-[300ms] ease-in-out origin-left rounded-md"></span>
        </button>
      </div>
    </div>
  );
