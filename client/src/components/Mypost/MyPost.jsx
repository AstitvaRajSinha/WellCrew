...
const MyPost = () => {
  ...
  const fetchMyPosts = async () => {
    try {
      setLoading(true);
      const response = await axios.get('https://wellcrew.onrender.com/api/auth/myposts', { withCredentials: true });
  ...
  const deletePost = async (postId) => {
    try {
      await axios.delete(`https://wellcrew.onrender.com/api/auth/posts/${postId}`, { withCredentials: true });
