...
const CommunityGroup = () => {
  ...
  useEffect(() => {
    ...
    socket.on('receiveGroupMessage', async (message) => {
      const enrichedMessage = {
        ...message,
        senderName: await fetchUserData(message.senderId), 
      };
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-100px)] bg-gray-900 text-white">
      ...
      <div className="flex p-4 items-center mt-4">
        ...
        <button
          ...
          className="bg-green-600 text-white px-6 py-2 ml-2 rounded-xl"
        >
          Send
        </button>
      </div>
