...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    const handleReceiveMessage = (data) => {
      ...
      // Update chat preview dynamically
      setChats((prevChats) =>
        prevChats.map((chat) =>
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="text-white p-4 w-full">
          {loading ? (
            ...
            chats.map((chat) => (
              <div
                key={chat._id}
                className="cursor-pointer w-full rounded-lg mb-8 py-4 px-8 hover:bg-gray-900"
      ...
      <div className="flex-grow border-l border-gray-600 h-full w-3/4">
        {currentChat ? (
          <ChatBox
            chat={currentChat}
          ...
          <>
            <div className="h-[calc(100vh-60px)] flex flex-col justify-center items-center">
              ...
              <div className="flex justify-center flex-col items-center py-6">
                ...
                <button className="align-center bg-green px-4 py-2 rounded-xl flex">Chat</button>
              </div>
            </div>
          </>
        )}
